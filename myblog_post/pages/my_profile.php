    ...
    <div class="nav-bar side">
        <div class="icon-container">
            <ul>
                ...
                <li>
                    <div class=" profile-detail exp" style="display: none">
                        <a href="">
                            <div class=" pro-img">
...
<div class="s-t-div">
 ...
 <div class="all">  
   ...
   <div class="news-div">
        <div class="profile">
            <img src="images/me.jpg" alt="my-image"> <br><br>
            <div class="details">
                <h2>Full Name: Salihu Abubakar Kutiriko</h2>
                <h2>Email: salihuabubakar08170@gmail.com</h2>
                <h2>Sex: male</h2>
                <h2></h2> 
            </div>
        </div>
